...
letra = \lyricmode {
    \teeny
    \tweak self-alignment-X #1  \markup{junto a}
    \tweak self-alignment-X #-1 \markup{\bold{vós}, felici-}
    \tweak self-alignment-X #-1 \markup{\bold{da}-}
    \tweak self-alignment-X #1  \markup{de}
    \tweak self-alignment-X #1  \markup{sem}
    \tweak self-alignment-X #1  \markup{li-}
    \tweak self-alignment-X #-1 \markup{\bold{mi}tes, *}
}
