...
%/recitação
  ...
  \addlyrics {
    \teeny
    \tweak self-alignment-X #1  \markup{O ini-}
    \tweak self-alignment-X #-1 \markup{\bold{mi}go humi-}
    \tweak self-alignment-X #-1 \markup{\bold{lha}}
    \tweak self-alignment-X #-1  \markup{do}
    \tweak self-alignment-X #-1  \markup{ve-}
