...
%/recitação
  ...
  \addlyrics {
    \teeny
    \tweak self-alignment-X #1  \markup{Sois tão}
    \tweak self-alignment-X #-1 \markup{\bold{gran}de e fa-}
    \tweak self-alignment-X #-1 \markup{\bold{zeis}}
    \tweak self-alignment-X #-1  \markup{ma-}
    \tweak self-alignment-X #-1  \markup{ra-}
    \tweak self-alignment-X #-1 \markup{\bold{vi}lhas:*}
  }
}
