...
%/recitação
  ...
  \addlyrics {
    \teeny
    \tweak self-alignment-X #1  \markup{E sal-}
    \tweak self-alignment-X #-1 \markup{\bold{vai} vosso }
    \tweak self-alignment-X #-1 \markup{\bold{ser}-}
    \tweak self-alignment-X #-1  \markup{vo}
