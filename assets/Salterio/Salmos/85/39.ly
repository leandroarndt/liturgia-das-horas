...
%/recitação
  ...
  \addlyrics {
    \teeny
    \tweak self-alignment-X #1  \markup{de vossa}
    \tweak self-alignment-X #-1 \markup{\bold{ser}va o}
    \tweak self-alignment-X #-1 \markup{\bold{fi}lho}
    \tweak self-alignment-X #-1  \markup{sal-}
    \tweak self-alignment-X #-1 \markup{\bold{vai}.}
  }
}
