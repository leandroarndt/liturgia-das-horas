...
%/recitação
  ...
  \addlyrics {
    \teeny
    \tweak self-alignment-X #1  \markup{Conce-}
    \tweak self-alignment-X #-1 \markup{\bold{dei}-me um si-}
    \tweak self-alignment-X #-1 \markup{\bold{nal}}
    \tweak self-alignment-X #-1  \markup{que}
    \tweak self-alignment-X #-1  \markup{me}
    \tweak self-alignment-X #-1 \markup{\bold{pro}ve*}
  }
}
