...
%/recitação
  ...
  \addlyrics {
    \teeny
    \tweak self-alignment-X #1  \markup{No meu}
    \tweak self-alignment-X #-1 \markup{\bold{dia} de an-}
    \tweak self-alignment-X #-1 \markup{\bold{gús}-}
    \tweak self-alignment-X #0  \markup{tia eu}
    \tweak self-alignment-X #-1  \markup{vos}
    \tweak self-alignment-X #-1 \markup{\bold{cha}mo,*}
  }
}
