...
%/recitação
  ...
  \addlyrics {
    \teeny
    \tweak self-alignment-X #1  \markup{Vós, po-}
    \tweak self-alignment-X #-1 \markup{\bold{rém}, sois cle-}
    \tweak self-alignment-X #-1 \markup{\bold{men}-}
    \tweak self-alignment-X #-1  \markup{te_e}
