...
%/recitação
  ...
  \addlyrics {
    \teeny
    \tweak self-alignment-X #1  \markup{que con-}
    \tweak self-alignment-X #-1 \markup{\bold{vos}co se}
    \tweak self-alignment-X #-1 \markup{\bold{pos}sa i-}
    \tweak self-alignment-X #-1  \markup{gua-}
    \tweak self-alignment-X #-1 \markup{\bold{lar};}
  }
}
