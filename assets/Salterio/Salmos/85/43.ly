...
%/recitação
  ...
  \addlyrics {
    \teeny
    \tweak self-alignment-X #1  \markup{que me}
    \tweak self-alignment-X #-1 \markup{\bold{des}tes a-}
    \tweak self-alignment-X #-1 \markup{\bold{ju}da e}
    \tweak self-alignment-X #-1  \markup{con-}
    \tweak self-alignment-X #-1 \markup{\bold{so}lo.}
  }
}
