...
letra = \lyricmode {
    \teeny
    \tweak self-alignment-X #1  \markup{toda}
    \tweak self-alignment-X #-1 \markup{\bold{gen}
                                        \hspace #-0.5
                                        te}
    \tweak self-alignment-X #-1 \markup{me}
    \tweak self-alignment-X #-1 \markup{\bold{vê} como um}
    \tweak self-alignment-X #-1 \markup{\bold{ca}} --
    \tweak self-alignment-X #-1 \markup{so}
    \tweak self-alignment-X #-1 \markup{per} --
