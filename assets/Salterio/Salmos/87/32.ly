...
letra = \lyricmode {
    \teeny
    \tweak self-alignment-X #1  E_por
    \tweak self-alignment-X #-1 \markup{\bold{que} es} --
    \tweak self-alignment-X #-0 \markup{con} --
    \tweak self-alignment-X #-1 \markup{\bold{deis} vossa}
    \tweak self-alignment-X #-1 \markup{\bold{fa}}
